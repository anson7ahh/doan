            ...
            <div class="w-full md:w-1/3 flex flex-col justify-between">
                ...
                <div>
                    ...
                    <select id="current_position-{{ $InvoiceFreight->id }}" class="w-full p-2 border rounded">
                        ...
                        <option value="Kho_Hà_nội"
                            {{ $InvoiceFreight->current_position == 'Kho_Hà_nội' ? 'selected' : '' }}>Kho Hà Nội</option>
                        <option value="Kho_Thanh_hóa"
                            {{ $InvoiceFreight->current_position == 'Kho_Thanh_hóa' ? 'selected' : '' }}>Kho Thanh Hóa
                        </option>
                    </select>
                </div>
            </div>
