...
<body class="w-full h-auto lg:h-screen bg-sitebg">
    ...
    <!-- Sidebar -->
    <aside
        class="scrollbar fixed top-0 left-0 z-40 w-72 lg:w-56 h-screen pt-16 transition-transform -translate-x-full bg-white border-r border-gray-200 lg:translate-x-0"
        ...
        <ul class="hidden lg:inline space-y-0.5">
            ...
            <li>
                <a href="subject.html"
                    ...
                    <span class="ml-3">Quản lý tài khoản nhân viên</span>
                </a>
            </li>
