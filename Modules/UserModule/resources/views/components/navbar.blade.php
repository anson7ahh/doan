<div>
    <nav class=' h-[100px]  w-full  border-2 border-b-red-400    flex flex-row lg:bg-white  
    lg:fixed relative z-30'>
        ...
        <div id='top-menu'
            class=' pl-5 lg:w-5/6 lg:h-full  lg:flex lg:justify-start  lg:flex-row lg:items-center 
            ...
            @if (Auth::check())
                <div id='user' class="flex flex-row relative  lg:w-1/6 justify-center ">
                    ...
                    <div id="userDetail" class="absolute w-[160px] mt-[60px] hidden bg-gray-100  h-[100px]  ">
                        <p class="uppercase text-center">chào:{{ Auth::user()->name }}</p>
                        <div class="flex flex-row justify-center pt-5">Thay đổi thông tin</div>
